...
- 生成时间：`2026-09-04 15:33:35`
- 结果根目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\04_Python震例特殊处理\Result_SMVCE_20260904153333_ws41_roi_all9_case_tuned`
- GeoTIFF 目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\04_Python震例特殊处理\Result_SMVCE_20260904153333_ws41_roi_all9_case_tuned\geotiff`
- GRD 导出：`disabled`
- SM-VCE 求解耗时：`48.21 s`
- 栅格尺寸：`61 x 101`
