...
- 生成时间：`2026-09-04 15:30:22`
- 结果根目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\01_Python复现模式\Result_SMVCE_20260904153022_ws41_roi_original7`
- GeoTIFF 目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\01_Python复现模式\Result_SMVCE_20260904153022_ws41_roi_original7\geotiff`
- GRD 导出：`disabled`
- SM-VCE 求解耗时：`33.68 s`
- 栅格尺寸：`61 x 101`
