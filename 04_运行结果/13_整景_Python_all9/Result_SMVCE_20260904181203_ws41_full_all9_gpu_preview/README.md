...
- 生成时间：`2026-09-04 18:12:11`
- 结果根目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\13_整景_Python_all9\Result_SMVCE_20260904181203_ws41_full_all9_gpu_preview`
- GeoTIFF 目录：`E:\#Post\2026.09.04 今日组会\04_运行结果\13_整景_Python_all9\Result_SMVCE_20260904181203_ws41_full_all9_gpu_preview\geotiff`
- GRD 导出：`disabled`
- SM-VCE 求解耗时：`883.02 s`
- 栅格尺寸：`1027 x 1373`
